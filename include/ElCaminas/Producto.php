...
class Producto
{
    ...
    public function getHtml(){
      ...
      $str .= "<a href='./carro.php?action=add&id=" . $this->id . "&cantidad=1&redirect=".$this->getUrl()."' class='btn btn-danger' style='position:absolute; bottom:4px; right:4px'>Comprar</a>";
